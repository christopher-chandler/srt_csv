...
def remove_quotation_characters_srt(incoming_file_name:str, outgoing_file_name:str) -> None:
    """
    ...
    with open(incoming_file_name, mode="r", encoding="utf-8", newline="") as incoming_file:
